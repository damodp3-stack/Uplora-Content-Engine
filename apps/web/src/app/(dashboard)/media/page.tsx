...
const sampleMedia = [
  { id: '1', title: 'Banner-AI.png', url: 'https://images.unsplash.com/photo-1618005182384-a83a8bd57fbe?auto=format&fit=crop&w=600&q=80', size: '1.4 MB' },
  { id: '2', title: 'Infographic-2026.png', url: 'https://images.unsplash.com/photo-1551288049-bebda4e38f71?auto=format&fit=crop&w=600&q=80', size: '2.1 MB' },
  { id: '3', title: 'Header-Bg.jpg', url: 'https://images.unsplash.com/photo-1526374965328-7f61d4dc18c5?auto=format&fit=crop&w=600&q=80', size: '980 KB' },
];
    ...
    <div className="space-y-6">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 glass-card rounded-2xl p-5 border border-gray-800">
        <div>
          ...
          <p className="text-xs text-gray-400">Store and manage images, banners, and video assets</p>
        </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
        {sampleMedia.map((item) => (
          <div key={item.id} className="glass-card rounded-2xl overflow-hidden border border-gray-800 group hover:border-purple-500/40 transition-colors">
            ...
            <div className="p-3 flex items-center justify-between text-xs">
              <div>
                <p className="font-bold text-white truncate max-w-[140px]">{item.title}</p>
